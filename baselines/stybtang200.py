...
from data import BayesOptDataset, FuncStybTang_V1
...
KERNEL_FLAGS = {
    ...
    "mat52":          {"kernel": "mat52",   "set_ls": True,  "if_ard": False},
    "mat52_ard":      {"kernel": "mat52",   "set_ls": True,  "if_ard": True},
...
def run_one(kernel: str, seed: int, num_iter: int, beta: float,
            root_dir: str, func_name: str = "StybTang"):
    ...
    func    = FuncStybTang_V1(DIM, maximize=True)
