...
from data import BayesOptDataset, FuncAckleyKRY150
...
KERNEL_FLAGS = {
    ...
    "mat32":          {"kernel": "mat32",   "set_ls": False,  "if_ard": False},
    "mat32_ard":      {"kernel": "mat32",   "set_ls": False,  "if_ard": True},
    "mat32_ard_ri":   {"kernel": "mat32",   "set_ls": True,  "if_ard": True},
    "mat32_ri":       {"kernel": "mat32",   "set_ls": True,  "if_ard": False},          
...
def run_one(kernel: str, seed: int, num_iter: int, beta: float,
            root_dir: str, func_name: str = "AckleyKRY300-150"):
    ...
    func    = FuncAckleyKRY150(DIM, maximize=True)
